import { resetAddVideoState } from "@/slices/videoSlice";
...
export default function AddVideo() {
  const { handleCreate, loading } = useCreateVideo();
    ...
    <div className="bg-amber-50">
      ...
      {!showAddVideo && (
        <>
          ...
          {!loading && videoData.addVideoError && (
            <ErrorComponent
          ...
          {!loading && videoData.addVideoSuccess && (
            <SucessComponent
